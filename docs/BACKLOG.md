...
|---|---|---|---|---|
| **C1** | Multiple-comparison correction (BH-FDR/Bonferroni) over the claim registry; track comparison count | ~45-cell grid + per-run accept at α=0.05 ⇒ uncontrolled family-wise false positives | M | no (claim_registry) |
