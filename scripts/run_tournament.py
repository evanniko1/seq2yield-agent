...
def main() -> None:
    ...
    print(f"\n=== tournament: {scope}  [{res.scope}, {res.bootstrap_unit}-unit, "
          f"n={res.n_units}, train={res.train_size}] ===")
    print(f"{'rank':>4}  {'model':<12}{'R²':>9}{'Δ_vs_win':>10}{'q_value':>9}  fdr  source")
    for c in res.leaderboard:
        ...
        print(f"{c.rank:>4}  {c.model:<12}{c.r2:>9.4f}{(c.delta_vs_winner or 0):>10.4f}"
